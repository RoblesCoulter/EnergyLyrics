...
import re
import os
from English_to_IPA import stress
...
def cmu_to_ipa(cmu_list, mark=True, stress_marking=True):
    ...
    symbols = {"a": "ə", "ey": "eɪ", "aa": "ɑ", "ae": "æ", "ah": "ʌ", "ao": "ɔ", "aw": "aʊ", "ay": "aɪ", "ch": "ʧ",
               "dh": "ð", "eh": "ɛ", "er": "ɝ", "hh": "h", "ih": "ɪ", "jh": "ʤ", "ng": "ŋ",  "ow": "oʊ", "oy": "ɔɪ",
...
def convert(user_in, retrieve='TOP'):
    ...
    ipa_words = cmu_to_ipa([[cmu_list[0][-1]]])
